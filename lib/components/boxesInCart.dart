        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              itemCount: widget.boxCartMongodb.length,
              itemBuilder: (context, index) {
                var item = widget.boxCartMongodb[index];
                return InkWell(
                  onTap: () {
                    List<int> quantidades = [];
                    for (var element in widget.boxCartWithRightQuantities[index]
                        ['boxProducts']) {
                                  ...
                                  onPressed: () {
                                    if (boxQuantity[index] > 0) {
                                      ...
                                      CartController controller =
                                          CartController();
                                      controller.incrementOrSubtractBoxQuantity(
                                        item['box'],
                                        "-",
                                      );
                                      widget.callback(
